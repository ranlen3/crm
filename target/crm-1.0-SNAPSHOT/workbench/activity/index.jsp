...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	$(function(){
		...
		//动态生成的元素不能以普通绑定事件的形式来进行操作
		// $("input[name=xz]").click(function () {
		//
		// })

		/*
		动态生成的元素,要以on方法形式来触发事件
		语法：
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 81%;">
                                <!--
                                关于文本域textarea，
                                    （1）一定是要以标签对的形式来呈现，正常状态下标签对要紧紧的挨着（标签对间的内容添加在文本域中）
                                    （2）textarea虽然是以标签对的形式呈现，但属于表单元素范畴，使用val()方法对其取值和赋值
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				<div class="btn-group" style="position: relative; top: 18%;">
					<!--
					data-toggle="modal" 表示将要打开一个模态窗口

					data-target="#createActivityModal"
					表示拿到那个模态窗口，通过id

					打开模态窗口写死在元素中，没办法对按钮的功能经行扩充

					实际开发，对于触发窗口操作，应该由自己写js代码来操作
